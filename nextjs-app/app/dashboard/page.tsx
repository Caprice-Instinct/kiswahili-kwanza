  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-gray-900 dark:to-gray-800 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Parent/Guardian Portal Card */}
        <div className="mt-8">
          <Card className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 border-amber-200/50 dark:border-amber-700/30">
            <CardHeader>
            ...
            <CardContent>
              <p className="dyslexic-text mb-4 text-amber-600 dark:text-amber-400">
                Wazazi/Malezi wanaweza kuona maendeleo ya mwanafunzi na taarifa
                muhimu hapa.
              </p>
              <Link href="/parent-portal">
                <Button
                  variant="outline"
                  className="w-full dyslexic-text bg-white dark:bg-gray-800 border-amber-300 dark:border-amber-600"
                >
                  <Star className="h-4 w-4 mr-2" />
                  Fungua Portal ya Mzazi/Mlezi
                </Button>
              </Link>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="bg-gradient-to-br from-sky-50 to-sky-100 dark:from-sky-900/20 dark:to-sky-800/20 border-sky-200/50 dark:border-sky-700/30">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium dyslexic-text text-sky-800 dark:text-sky-200">
                Kiwango
              </CardTitle>
              <Trophy className="h-4 w-4 text-sky-600 dark:text-sky-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold dyslexic-text text-sky-800 dark:text-sky-200">
          ...
          <Card className="bg-gradient-to-br from-violet-50 to-violet-100 dark:from-violet-900/20 dark:to-violet-800/20 border-violet-200/50 dark:border-violet-700/30">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium dyslexic-text text-violet-800 dark:text-violet-200">
                Alama
              </CardTitle>
              <Star className="h-4 w-4 text-violet-600 dark:text-violet-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold dyslexic-text text-violet-800 dark:text-violet-200">
          ...
          <Card className="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-800/20 border-pink-200/50 dark:border-pink-700/30">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium dyslexic-text text-pink-800 dark:text-pink-200">
                Maendeleo
              </CardTitle>
            ...
            <CardContent>
              <div className="text-2xl font-bold dyslexic-text text-pink-800 dark:text-pink-200">
                {progress?.progress?.length > 0
                  ? Math.round(
                      (progress.progress.filter((p: any) => p.completed)
                        .length /
          ...
          <Card className="bg-gradient-to-br from-sky-50 to-sky-100 dark:from-sky-900/20 dark:to-sky-800/20 border-sky-200/50 dark:border-sky-700/30">
            ...
            <CardContent>
              <p className="dyslexic-text mb-4 text-sky-600 dark:text-sky-400">
                {lessons.length > 0
                  ? `Masomo ${lessons.length} yapatikana`
            ...
            <CardContent>
              <p className="dyslexic-text mb-4 text-violet-600 dark:text-violet-400">
                {progress?.dailyProgress
                  ? `Leo: ${progress.dailyProgress.exercisesCompleted} mazoezi`
                  : "Fanya mazoezi ya haraka kupata alama zaidi"}
              </p>
              <Link href="/practice">
                <Button
                  variant="outline"
                  className="w-full dyslexic-text bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600"
                >
