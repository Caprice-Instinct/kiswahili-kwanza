...
export function QuizResults({ quiz, answers, onRetry }: QuizResultsProps) {
  ...
  const getPerformanceMessage = () => {
    if (results.percentage >= 90) return { message: "Bora sana!", icon: Trophy, color: "text-yellow-600" };
    if (results.percentage >= 80) return { message: "Vizuri sana!", icon: Star, color: "text-blue-600" };
    if (results.percentage >= 70) return { message: "Vizuri!", icon: CheckCircle, color: "text-green-600" };
    if (results.percentage >= 60) return { message: "Sawa!", icon: CheckCircle, color: "text-green-600" };
    return { message: "Jaribu tena!", icon: RotateCcw, color: "text-orange-600" };
  };
    ...
    <div className="space-y-6 w-full max-w-4xl mx-auto">
      ...
      <Card>
        <CardHeader className="text-center">
          ...
          <Badge variant={results.passed ? "default" : "secondary"} className="text-lg px-4 py-1">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="text-center p-3 bg-green-50 rounded-lg">
              <div className="text-2xl font-bold text-green-600">{results.totalScore}</div>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm text-gray-600">{results.percentage}%</span>
            </div>
            ...
            {results.questionResults.map((result, index) => (
              <div key={result.question.id} className="border rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    <span className="font-medium text-gray-700">Jibu lako: </span>
                  ...
                  {!result.isCorrect && (
                    <div>
                      <span className="font-medium text-gray-700">Jibu sahihi: </span>
                  ...
                  {result.question.explanation && (
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <span className="font-medium text-blue-800">Maelezo: </span>
